# ADR 0009: LoxBerry-Webserver-Zertifikat diagnostizieren und neu ausstellen

> **Identifier correction:** This decision was previously published with the
> duplicate identifier ADR 0005. Its content is unchanged; ADR 0009 is its
> unique identifier from the beta documentation consolidation onward.
