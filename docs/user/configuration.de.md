...
Eine geöffnete Ansicht prüft bei sichtbarem Tab regelmäßig einen lokalen Änderungsmarker. Wenn ein anderer Browser Quellen hinzufügt, beendet oder deren gespeicherte Daten löscht, lädt sie die autorisierte Quellenübersicht erneut. Ohne solche Änderungen erfolgt dabei keine zusätzliche Miniserver-Strukturabfrage.
